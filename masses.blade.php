...
<head>
  ...
  <title>Mass Times & Sacraments — St. Patrick's Catholic Cathedral</title>
...
<div class="ticker-wrap" style="position:relative;z-index:1001;">
  <div id="ticker-text" class="ticker-content font-cinzel text-xs tracking-widest text-white opacity-90">
    &nbsp;&nbsp;&nbsp;✦ HOLY MASS: Weekdays 6:30am &amp; 7:00am &nbsp;|&nbsp; ✦ Adoration: Fridays 4:00pm &nbsp;&nbsp;&nbsp;
  </div>
</div>
...
<nav id="navbar" class="py-4 px-6 md:px-12">
  <div class="max-w-7xl mx-auto flex items-center justify-between">
    ...
    <div class="hidden lg:flex items-center gap-8">
      ...
      <a href="masses.html"  class="nav-link active">MASSES</a>
...
<section class="page-hero" style="padding-top:8.5rem;padding-bottom:5rem;">
  <div class="page-hero-bg" style="background-image:url('https://images.unsplash.com/photo-1519677100203-a0e668c92439?w=1920&q=80');"></div>
  <div style="position:absolute;inset:0;background:linear-gradient(to bottom,rgba(15,5,3,0.65),rgba(15,5,3,0.92));"></div>
  <div class="relative z-10 max-w-3xl mx-auto px-6">
    <p class="font-cinzel text-xs tracking-[0.4em] mb-4 fade-up" style="color:var(--gold);">LITURGY &amp; WORSHIP</p>
    <h1 class="font-cinzel font-black text-white mb-4 fade-up delay-1" style="font-size:clamp(2.2rem,5vw,4rem);">Mass Times &amp; Sacraments</h1>
    <div class="ornament fade-up delay-2"><span class="ornament-icon">✦</span></div>
    <p class="font-cormorant text-xl text-gray-300 fade-up delay-3" style="font-size:1.2rem;">Come, celebrate, receive — every sacrament, every day of the week.</p>
  </div>
</section>
...
<section class="section-mid py-20 px-6">
  <div class="max-w-5xl mx-auto">
    <div class="text-center mb-14 reveal">
      <p class="font-cinzel text-xs tracking-[0.3em] mb-3" style="color:var(--gold);">HOLY EUCHARIST</p>
      <h2 class="font-cinzel text-3xl md:text-4xl font-bold text-white">Weekly Mass Schedule</h2>
      <div class="ornament"><span class="ornament-icon">✦</span></div>
    </div>

    <!-- Visual schedule table -->
    <div class="reveal overflow-hidden rounded-sm" style="border:1px solid rgba(201,164,120,0.2);">
      <!-- Header -->
      <div class="grid grid-cols-3 text-center py-4 px-6 font-cinzel text-xs tracking-widest" style="background:rgba(201,164,120,0.1);color:var(--gold);border-bottom:1px solid rgba(201,164,120,0.2);">
        <div>DAY</div>
        <div>TIME(S)</div>
        <div>LANGUAGE</div>
      </div>
      <!-- Rows — populated from CathedralDB -->
      <div id="mass-schedule-body" class="divide-y" style="divide-color:rgba(201,164,120,0.08);"></div>
    </div>
    <p class="text-gray-500 text-xs mt-4 text-center">* Stations of the Cross during Lenten Season only.</p>
  </div>
</section>
...
<section class="section-dark py-20 px-6">
  <div class="max-w-5xl mx-auto">
    <div class="text-center mb-14 reveal">
      <p class="font-cinzel text-xs tracking-[0.3em] mb-3" style="color:var(--gold);">DEVOTIONAL LIFE</p>
      <h2 class="font-cinzel text-3xl md:text-4xl font-bold text-white">Special Devotions &amp; Prayers</h2>
      <div class="ornament"><span class="ornament-icon">✦</span></div>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 reveal" id="devotions-grid"></div>
  </div>
</section>


<!-- ══════ SACRAMENTS ══════ -->
<section class="parallax-strip py-24 px-6" style="background-image:url('https://images.unsplash.com/photo-1548625149-720754952f87?w=1920&q=80');">
  <div style="position:absolute;inset:0;background:rgba(15,5,3,0.88);"></div>
  <div class="relative max-w-6xl mx-auto">
    <div class="text-center mb-14 reveal">
      <p class="font-cinzel text-xs tracking-[0.3em] mb-3" style="color:var(--gold);">PATHWAYS OF GRACE</p>
      <h2 class="font-cinzel text-3xl md:text-4xl font-bold text-white">The Seven Sacraments</h2>
      <div class="ornament"><span class="ornament-icon">✦</span></div>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 reveal" id="sacraments-grid"></div>
  </div>
</section>
...
<!-- ══════ CATECHISM ══════ -->
<section class="section-mid py-20 px-6">
  <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center reveal">
    <div>
      <p class="font-cinzel text-xs tracking-[0.3em] mb-3" style="color:var(--gold);">FAITH FORMATION</p>
      <h2 class="font-cinzel text-3xl md:text-4xl font-bold text-white mb-5">Catechism &amp; RCIA</h2>
      <div class="ornament justify-start"><span class="ornament-icon">✦</span></div>
      <p class="text-gray-300 leading-relaxed mb-4">Our catechetical programme prepares children and adults alike to receive the sacraments and live as committed disciples of Jesus Christ.</p>
      <div class="space-y-4" id="catechism-list"></div>
    </div>
    <div class="relative">
      <img src="https://images.unsplash.com/photo-1596496181848-3091d4878b24?w=700&q=80" alt="Faith formation" class="w-full object-cover rounded-sm" style="height:420px;">
      <div class="absolute inset-0 rounded-sm" style="background:linear-gradient(to top,rgba(15,5,3,0.6),transparent);"></div>
    </div>
  </div>
</section>
...
<section class="section-mid py-20 px-6 reveal">
  <div class="max-w-6xl mx-auto flex justify-center">
    <div class="w-full max-w-2xl text-center px-8 md:px-14 py-14 relative overflow-hidden" style="background:linear-gradient(150deg,#3d1809 0%,#1a0a04 60%,#2e1008 100%);border:1px solid rgba(201,164,120,0.22);border-radius:18px;box-shadow:0 28px 70px rgba(0,0,0,0.6),inset 0 1px 0 rgba(201,164,120,0.1);">
      ...
      <p class="scripture-quote text-white mb-6 relative z-10">Do this in memory of me.</p>
      <div class="ornament relative z-10"><span class="ornament-icon">✦</span></div>
      <p class="font-cinzel text-xs tracking-[0.3em] mt-5 relative z-10" style="color:var(--gold-light);">— LUKE 22:19</p>
    </div>
  </div>
</section>
...
<script>
(function renderMassesPage() {
  /* Ticker */
  const ticker = document.getElementById('ticker-text');
  if (ticker) { const t = CathedralDB.buildTickerText(); if(t) ticker.textContent = t; }

  /* Mass schedule */
  const scheduleEl = document.getElementById('mass-schedule-body');
  if (scheduleEl) {
    const masses = CathedralDB.get('masses') || [];
    const WEEKEND = ['Saturday','Sunday'];
    scheduleEl.innerHTML = masses.map((m, i) => {
      const isWeekend = WEEKEND.includes(m.day);
      const bg = isWeekend ? `style="background:rgba(201,164,120,${isWeekend && m.day==='Sunday' ? '0.1' : '0.07'});"` : (i % 2 === 1 ? 'style="background:rgba(201,164,120,0.04);"' : '');
      const nameColor = isWeekend ? `style="color:var(--gold-light);"` : '';
      const noteText = m.note ? ` · <em class="text-xs text-gray-500">${m.note}</em>` : '';
      return `
      <div class="grid grid-cols-3 text-center py-5 px-6 hover:bg-white/5 transition-colors" ${bg}>
        <div class="font-cinzel text-sm font-bold text-white" ${nameColor}>${m.day}</div>
        <div class="text-gray-300 text-sm">${m.times.replace(/·/g,'&nbsp;·&nbsp;').replace(/·/g,'·')}</div>
        <div class="text-gray-400 text-sm">${m.language}${noteText}</div>
      </div>`;
    }).join('') || '<div class="py-6 text-center text-gray-500 text-sm">No mass schedule available.</div>';
  }

  /* Devotions */
  const devotionsEl = document.getElementById('devotions-grid');
  if (devotionsEl) {
    const DEVOT_EMOJIS = { 'Eucharistic Adoration':'🕯', 'Holy Rosary':'📿', 'Stations of the Cross':'✝', 'Novena to Our Lady':'🌹', 'Charismatic Prayer':'🔥', 'Bible Study':'📖' };
    const devs = (CathedralDB.get('devotions') || []).filter(d => d.active !== false);
    devotionsEl.innerHTML = devs.map(d => {
      const emoji = DEVOT_EMOJIS[d.title] || '🙏';
      return `
      <div class="card-glass p-6 rounded-sm">
        <div class="text-3xl mb-3">${emoji}</div>
        <h4 class="font-cinzel font-bold text-white mb-1">${d.title}</h4>
        <p class="font-cinzel text-xs tracking-wider mb-2" style="color:var(--gold);">${d.schedule.toUpperCase()}</p>
        <p class="text-gray-400 text-sm">${d.description}</p>
      </div>`;
    }).join('') || '<p class="text-gray-500 col-span-3 text-center">No devotions listed.</p>';
  }

  /* Sacraments */
  const sacramentsEl = document.getElementById('sacraments-grid');
  if (sacramentsEl) {
    const sacs = (CathedralDB.get('sacraments') || []).sort((a,b) => (a.order||0)-(b.order||0));
    sacramentsEl.innerHTML = sacs.map(s => `
      <div class="sacrament-box">
        <div class="text-3xl mb-3" style="color:var(--gold);">${s.emoji}</div>
        <h4 class="font-cinzel text-sm font-bold text-white mb-2">${s.name.toUpperCase()}</h4>
        <p class="text-gray-400 text-xs leading-relaxed">${s.description}</p>
      </div>`).join('') || '<p class="text-gray-500">No sacraments listed.</p>';
  }

  /* Catechism */
  const catEl = document.getElementById('catechism-list');
  if (catEl) {
    const cats = (CathedralDB.get('catechism') || []).filter(c => c.active !== false).sort((a,b) => (a.order||0)-(b.order||0));
    catEl.innerHTML = cats.map(c => `
      <div class="mass-card rounded-sm">
        <div class="flex items-center justify-between mb-1 gap-2">
          <div class="font-cinzel text-xs tracking-wider" style="color:var(--gold);">${c.name.toUpperCase()}</div>
          <div class="font-cinzel text-xs text-gray-500">${c.audience}</div>
        </div>
        <div class="text-white text-sm font-semibold">${c.schedule}</div>
        <p class="text-gray-400 text-xs mt-1">${c.description}</p>
      </div>`).join('') || '<p class="text-gray-500">No programmes listed.</p>';
  }
})();
</script>
</body>
